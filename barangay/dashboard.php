        ...
        <nav class="sidebar-nav">
            <ul>
               <li><a href="dashboard.php" class="<?php echo basename($_SERVER['PHP_SELF']) === 'dashboard.php' ? 'active' : ''; ?>"><i class="fas fa-house-user"></i> Dashboard</a></li>
                ...
                <li><a href="reports.php" class="<?php echo basename($_SERVER['PHP_SELF']) === 'reports.php' ? 'active' : ''; ?>"><i class="fas fa-file-alt"></i> Reports</a></li>
                <?php if ($is_logged_in): ?>
            ...
            <div class="card" style="grid-column: 3; grid-row: 2;">
                ...
                <div class="card-body">
                    <div class="action-buttons">
                        <button class="action-btn" onclick="window.location.href='resident.php?action=add'">
                            <i class="fas fa-user-plus"></i> Add Resident
                        </button>
                        <button class="action-btn" onclick="window.location.href='events.php?action=add'">
